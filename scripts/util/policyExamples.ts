...
ex:usagePolicy1 odrl:uid ex:usagePolicy1 .
...
ex:usagePolicy1a odrl:uid ex:usagePolicy1a .
...
ex:usagePolicy2a odrl:uid ex:usagePolicy2a .
...
ex:usagePolicy3 odrl:uid ex:usagePolicy3 .
...
ex:usagePolicyBad odrl:uid ex:usagePolicyBad .
...
<urn:uuid:95efe0e8-4fb7-496d-8f3c-4d78c97829bc> a <http://www.w3.org/ns/odrl/2/Set>;
    ...
    <http://www.w3.org/ns/odrl/2/uid> <urn:uuid:95efe0e8-4fb7-496d-8f3c-4d78c97829bc>;
...
ex:usagePolicy1-read odrl:uid ex:usagePolicy1-read .
...
ex:usagePolicy1-write odrl:uid ex:usagePolicy1-write .
...
ex:usagePolicy1-append odrl:uid ex:usagePolicy1-append .
...
ex:usagePolicy1a-control-1 odrl:uid ex:usagePolicy1a-control-1 .
...
ex:usagePolicy1a-control-2 odrl:uid ex:usagePolicy1a-control-2 .
...
<urn:uuid:policy-append> a odrl:Set;
    odrl:uid <urn:uuid:policy-append> ;
...
<urn:uuid:policy-write> a odrl:Set;
    odrl:uid <urn:uuid:policy-write> ;
...
ex:usagePolicy3-create odrl:uid ex:usagePolicy3-create .
...
ex:usagePolicy3b-create odrl:uid ex:usagePolicy3b-create .
...
ex:usagePolicy3b-read odrl:uid ex:usagePolicy3b-read .
...
ex:usagePolicy3b-write odrl:uid ex:usagePolicy3b-write .
...
ex:usagePolicy3b-control odrl:uid ex:usagePolicy3b-control .
